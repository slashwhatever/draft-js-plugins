                        ...
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 62:
                              ...
                              if (
                                !(
                                  (q = Object.keys(G.groups).filter(function (
                                    t
                                  ) {
                                    return !T[t];
                                  })).length > 0
                            ...
                            case 105:
                              return (
                                (e.next = 107),
                                this.getRouteInfo(rt, rt, T, a, { shallow: !1 })
                              );
                            case 107:
                              J = e.sent;
                            case 108:
                            ...
                            case 113:
                              ...
                              throw (
                                (t.events.emit('routeChangeError', Y, w, g), Y)
                              );
                            case 116:
                              return (
