  ...
  [6],
  {
    ...
    a2pL: function (e, t, o) {
        ...
        function t() {
          ...
          return (
            ...
            (t.onEmojiSelect = function (e) {
              t.closeDropdown();
              var o = ae(t.props.store.getEditorState(), e, ie);
            ...
            (t.getEmojisForFilter = function () {
              var e = t.props.store.getEditorState().getSelection(),
                o = ne(t.props.store.getEditorState(), e).word,
              ...
              (t.onMouseDown = function () {
                (t.mouseDown = !0),
                  t.props.onEmojiMouseDown &&
                    t.props.onEmojiMouseDown($(t), t.props.toneSet || null);
              }),
              (t.onMouseEnter = function () {
      ...
      (ue.propTypes = {
        ...
        mouseDown: W.a.bool,
        checkMouseDown: W.a.func.isRequired,
        onEmojiSelect: W.a.func.isRequired,
        onEmojiMouseDown: W.a.func,
      }),
        (ue.defaultProps = { mouseDown: !1 });
      var de = (function (e) {
        function t() {
      ...
      de.propTypes = {
        theme: W.a.object.isRequired,
        group: W.a.object.isRequired,
        emojis: W.a.object.isRequired,
        checkMouseDown: W.a.func.isRequired,
        onEmojiSelect: W.a.func.isRequired,
        onEmojiMouseDown: W.a.func.isRequired,
        isActive: W.a.bool,
      };
      var pe = (function (e) {
        function t() {
      ...
      pe.propTypes = {
        theme: W.a.object.isRequired,
        groups: W.a.arrayOf(W.a.object).isRequired,
        emojis: W.a.object.isRequired,
        checkMouseDown: W.a.func.isRequired,
        onEmojiSelect: W.a.func.isRequired,
        onEmojiMouseDown: W.a.func.isRequired,
        onGroupScroll: W.a.func.isRequired,
        isOpen: W.a.bool,
      };
      var fe = (function (e) {
        function t() {
      ...
      (fe.propTypes = {
        theme: W.a.object.isRequired,
        icon: W.a.oneOfType([W.a.element, W.a.string]).isRequired,
        groupIndex: W.a.number.isRequired,
        isActive: W.a.bool,
        onGroupSelect: W.a.func.isRequired,
      }),
        (fe.defaultProps = { isActive: !1 });
      var he = function (e) {
        var t = e.theme,
          o = void 0 === t ? {} : t,
          n = e.groups,
      ...
      he.propTypes = {
        theme: W.a.object.isRequired,
        groups: W.a.arrayOf(W.a.object).isRequired,
        activeGroup: W.a.number.isRequired,
        onGroupSelect: W.a.func.isRequired,
      };
      var me = (function (e) {
        function t() {
      ...
      me.propTypes = {
        theme: W.a.object.isRequired,
        bounds: W.a.shape({
          areaBounds: W.a.shape({
            left: W.a.number.isRequired,
            right: W.a.number.isRequired,
            top: W.a.number.isRequired,
            bottom: W.a.number.isRequired,
            width: W.a.number.isRequired,
            height: W.a.number.isRequired,
          }).isRequired,
          entryBounds: W.a.shape({
            left: W.a.number.isRequired,
            right: W.a.number.isRequired,
            top: W.a.number.isRequired,
            bottom: W.a.number.isRequired,
      ...
      var ve = (function (e) {
        function t() {
          ...
          return (
            ...
            (t.onEmojiSelect = function (e) {
              var o = ae(t.props.store.getEditorState(), e);
              t.props.store.setEditorState(o);
            }),
      ...
      (ve.propTypes = {
        theme: W.a.object.isRequired,
        store: W.a.object.isRequired,
        groups: W.a.arrayOf(W.a.object).isRequired,
        emojis: W.a.object.isRequired,
        toneSelectOpenDelay: W.a.number.isRequired,
        isOpen: W.a.bool,
      }),
        (ve.defaultProps = { isOpen: !1 });
      var ge = (function () {
          for (var e, t = {}, o = ee(U); !(e = o()).done; ) {
            var n = e.value,
            ...
            if (
              ...
              for (var a, s = ee(n.skins); !(a = s()).done; ) {
                var l = a.value,
      ...
      (be.propTypes = {
        theme: W.a.object.isRequired,
        store: W.a.object.isRequired,
        selectGroups: W.a.arrayOf(
          W.a.shape({
            title: W.a.string.isRequired,
            icon: W.a.oneOfType([W.a.element, W.a.string]).isRequired,
            categories: W.a.arrayOf(W.a.oneOf(Object.keys(ge))).isRequired,
          })
        ),
        selectButtonContent: W.a.oneOfType([W.a.element, W.a.string]),
        toneSelectOpenDelay: W.a.number,
      }),
        (be.defaultProps = {
          selectButtonContent: '\u263a',
          selectGroups: ce,
      ...
      var ye = F.a.escapeRegExp(F.a.unicodeCharRegex()),
        Se = new RegExp(
      ...
      function Ae(e) {
        ...
        if (!c) return r.a.createElement(He, { decoratedText: o, theme: n }, i);
        var u = 'url(' + c + ')',
      ...
      t.a = function (e) {
        ...
        var t,
          ...
          b = c.useNativeArt,
          y = c.emojiImage,
          S = void 0 === y ? (b ? Pe : xe) : y,
          j = c.emojiInlineText,
          w = void 0 === j ? (b ? He : Ae) : j;
        h && De.setPriorityList(h);
        var E = {
            ariaProps: n,
            callbacks: o,
            theme: d,
            ...
            shortNames: Object(i.List)(L(De.list)),
            emojiImage: S,
          },
          T = {
            theme: d,
        ...
        return {
          EmojiSuggestions: function (e) {
            return r.a.createElement(se, Z({}, e, E));
          },
          EmojiSelect: function (e) {
            return r.a.createElement(be, Z({}, e, T));
          },
          decorators: [
            {
              strategy: je,
            ...
            },
            {
              strategy: Ee,
              component: function (e) {
                return r.a.createElement(le, Z({}, e, { store: l }));
              },
            },
          ],
