(window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [7],
  {
    Mpt7: function (t, e, r) {
      ...
      function et(t) {
        var e = Array.isArray(t) ? new Y(t) : T(t) ? new $(t) : void 0;
      ...
      function nt(t) {
        return H(t) ? new Y(t) : T(t) ? new $(t) : void 0;
      }
      ...
      function Wt(t) {
        return Object.create((m(t) ? F : S(t) ? G : X).prototype);
      }
      function Jt() {
      ...
      function Qt(t) {
        return 'object' === typeof t && (j(t) || Array.isArray(t) || Yt(t));
      }
      function Zt(t) {
        try {
      ...
      function $t(t, e) {
        return j(t) ? t.has(e) : Qt(t) && J.call(t, e);
      }
      function te(t, e, r) {
        return j(t)
          ? t.get(e, r)
      ...
      function ye(t, e, r) {
        return de(
          ...
          (function (t) {
            function e(r, n, i) {
              return Qt(r) && Qt(n) ? de(r, [n], e) : t ? t(r, n, i) : n;
            }
            return e;
          })(r)
        );
      ...
      (Qe[Ge] = !0),
        ...
        (Qe.wasAltered = Ee),
        (Qe.asImmutable = Ie),
        (Qe['@@transducer/init'] = Qe.asMutable = ze),
      ...
      var yr = (function (t) {
        ...
        return (
          ...
          (e.prototype.__iterate = function (t, e) {
            var r = this;
            if (e)
              return new Y(this.toArray()).__iterate(function (e, n) {
                return t(e, n, r);
              }, e);
          ...
          (e.prototype.__iterator = function (t, e) {
            if (e) return new Y(this.toArray()).__iterator(t, e);
            var r = 0,
              n = this._head;
            return new K(function () {
              if (n) {
        ...
        var r,
          n = function (o) {
            ...
            (this.__ownerID = void 0),
              (this._values = Ye().withMutations(function (t) {
      ...
      function cn(t, e, r, n, i, o) {
        var u = Array.isArray(r) ? G : Yt(r) ? F : null;
        if (u) {
          if (~t.indexOf(r))
            throw new TypeError(
          ...
          function e() {
            ...
            return (
              ...
              (e.onMouseEnter = function () {
                l('hidden', document.body);
              }),
              (e.onMouseLeave = function () {
                l('auto', document.body);
              }),
              ...
              (e.add = function (t) {
                ...
                r.onChange(c(r.state.editorState, t));
              }),
              e
            );
          }
