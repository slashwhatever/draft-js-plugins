    ...
    '23EE': function (e, f, a) {
      !(function (e) {
        (e.emojiList = {
          ...
          (e.asciiRegexp =
            "(\\*\\\\0\\/\\*|\\*\\\\O\\/\\*|\\-___\\-|\\:'\\-\\)|'\\:\\-\\)|'\\:\\-D|\\>\\:\\-\\)|>\\:\\-\\)|'\\:\\-\\(|\\>\\:\\-\\(|>\\:\\-\\(|\\:'\\-\\(|O\\:\\-\\)|0\\:\\-3|0\\:\\-\\)|0;\\^\\)|O;\\-\\)|0;\\-\\)|O\\:\\-3|\\-__\\-|\\:\\-\xde|\\:\\-\xde|\\<\\/3|<\\/3|\\:'\\)|\\:\\-D|'\\:\\)|'\\=\\)|'\\:D|'\\=D|\\>\\:\\)|>\\:\\)|\\>;\\)|>;\\)|\\>\\=\\)|>\\=\\)|;\\-\\)|\\*\\-\\)|;\\-\\]|;\\^\\)|'\\:\\(|'\\=\\(|\\:\\-\\*|\\:\\^\\*|\\>\\:P|>\\:P|X\\-P|\\>\\:\\[|>\\:\\[|\\:\\-\\(|\\:\\-\\[|\\>\\:\\(|>\\:\\(|\\:'\\(|;\\-\\(|\\>\\.\\<|>\\.<|#\\-\\)|%\\-\\)|X\\-\\)|\\\\0\\/|\\\\O\\/|0\\:3|0\\:\\)|O\\:\\)|O\\=\\)|O\\:3|B\\-\\)|8\\-\\)|B\\-D|8\\-D|\\-_\\-|\\>\\:\\\\|>\\:\\\\|\\>\\:\\/|>\\:\\/|\\:\\-\\/|\\:\\-\\.|\\:\\-P|\\:\xde|\\:\xde|\\:\\-b|\\:\\-O|O_O|\\>\\:O|>\\:O|\\:\\-X|\\:\\-#|\\:\\-\\)|\\(y\\)|\\<3|<3|\\=D|;\\)|\\*\\)|;\\]|;D|\\:\\*|\\=\\*|\\:\\(|\\:\\[|\\=\\(|\\:@|;\\(|D\\:|\\:\\$|\\=\\$|#\\)|%\\)|X\\)|B\\)|8\\)|\\:\\/|\\:\\\\|\\=\\/|\\=\\\\|\\:L|\\=L|\\:P|\\=P|\\:b|\\:O|\\:X|\\:#|\\=X|\\=#|\\:\\)|\\=\\]|\\=\\)|\\:\\]|\\:D)"),
          (e.emojiVersion = '6.0'),
          (e.emojiSize = '32'),
          (e.blacklistChars = ''),
          (e.imagePathPNG =
            ...
            e.emojiVersion +
            '/png/unicode/'),
          (e.defaultPathPNG = e.imagePathPNG),
          (e.fileExtension = '.png'),
          (e.imageTitleTag = !0),
          (e.sprites = !1),
          (e.unicodeAlt = !0),
          (e.ascii = !1),
          (e.riskyMatchAscii = !1),
          (e.regAscii = new RegExp(
            '<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|((\\s|^)' +
              e.asciiRegexp +
              '(?=\\s|$|[!,.?]))',
            'gi'
          )),
          (e.regAsciiRisky = new RegExp(
            '<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(()' +
              e.asciiRegexp +
              '())',
            'gi'
          )),
          (e.regUnicode = new RegExp(
            '<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(?:[\u1f91D[\u1f3fB-\u1f3fF]\u200d\u1f9f1\u200d\u1f91D[\u1f3fB-\u1f3fF]])|(?:\ud83c\udff3)\ufe0f?\u200d?(?:\ud83c\udf08)|(?:\ud83d\udc41)\ufe0f?\u200d?(?:\ud83d\udde8)\ufe0f?|[#-9]\ufe0f?\u20e3|(?:(?:\ud83c\udff4)(?:\udb40[\udc60-\udcff]){1,6})|(?:\ud83c[\udde0-\uddff]){2}|(?:\ud83d[\udc68\udc69])\ufe0f?(?:\ud83c[\udffa-\udfff])?\u200d?(?:[\u2695\u2696\u2708]|\ud83c[\udf3e-\udfed]|\ud83d[\udcbb\udcbc\udd27\udd2c\ude80\ude92])|(?:\ud83d[\udc68\udc69]|\ud83e[\uddd0-\udddf])(?:\ud83c[\udffa-\udfff])?\u200d?[\u2640\u2642\u2695\u2696\u2708]?\ufe0f?|(?:(?:\u2764|\ud83d[\udc66-\udc69\udc8b])[\u200d\ufe0f]{0,2}){1,3}(?:\u2764|\ud83d[\udc66-\udc69\udc8b])|(?:(?:\u2764|\ud83d[\udc66-\udc69\udc8b])\ufe0f?){2,4}|(?:\ud83d[\udc68\udc69\udc6e\udc71-\udc87\udd75\ude45-\ude4e]|\ud83e[\udd26\udd37]|\ud83c[\udfc3-\udfcc]|\ud83e[\udd38-\udd3e]|\ud83d[\udea3-\udeb6]|\u26f9|\ud83d\udc6f)\ufe0f?(?:\ud83c[\udffb-\udfff])?\u200d?[\u2640\u2642]?\ufe0f?|(?:[\u261d\u26f9\u270a-\u270d]|\ud83c[\udf85-\udfcc]|\ud83d[\udc42-\udcaa\udd74-\udd96\ude45-\ude4f\udea3-\udecc]|\ud83e[\udd18-\udd3e])\ufe0f?(?:\ud83c[\udffb-\udfff])|(?:[\u2194-\u2199\u21a9-\u21aa]\ufe0f?|[#*]|[\u3030\u303d]\ufe0f?|(?:\ud83c[\udd70-\udd71]|\ud83c\udd8e|\ud83c[\udd91-\udd9a])\ufe0f?|\u24c2\ufe0f?|[\u3297\u3299]\ufe0f?|(?:\ud83c[\ude01-\ude02]|\ud83c\ude1a|\ud83c\ude2f|\ud83c[\ude32-\ude3a]|\ud83c[\ude50-\ude51])\ufe0f?|[\u203c\u2049]\ufe0f?|[\u25aa-\u25ab\u25b6\u25c0\u25fb-\u25fe]\ufe0f?|[\xa9\xae]\ufe0f?|[\u2122\u2139]\ufe0f?|\ud83c\udc04\ufe0f?|[\u2b05-\u2b07\u2b1b-\u2b1c\u2b50\u2b55]\ufe0f?|[\u231a-\u231b\u2328\u23cf\u23e9-\u23f3\u23f8-\u23fa]\ufe0f?|\ud83c\udccf|[\u2934\u2935]\ufe0f?)|[\u2700-\u27bf]\ufe0f?|[\ud800-\udbff][\udc00-\udfff]\ufe0f?|[\u2600-\u26ff]\ufe0f?|[0-9]\ufe0f',
            'g'
          )),
          (e.convert = function (e) {
            if (e.indexOf('-') > -1) {
              for (var f = [], a = e.split('-'), _ = 0; _ < a.length; _++) {
                var o = parseInt(a[_], 16);
                if (o >= 65536 && o <= 1114111) {
                  var s = Math.floor((o - 65536) / 1024) + 55296,
                    t = ((o - 65536) % 1024) + 56320;
                  o = String.fromCharCode(s) + String.fromCharCode(t);
                } else o = String.fromCharCode(o);
                f.push(o);
              }
              return f.join('');
            }
            if ((a = parseInt(e, 16)) >= 65536 && a <= 1114111) {
              (s = Math.floor((a - 65536) / 1024) + 55296),
                (t = ((a - 65536) % 1024) + 56320);
              return String.fromCharCode(s) + String.fromCharCode(t);
            }
            return String.fromCharCode(a);
          }),
          (e.shortnameLookup = []),
          (e.altShortNames = []),
          (e.unicodeCharRegexCached = null);
        var f,
          a = [];
        for (f in e.emojiList)
          if (e.emojiList.hasOwnProperty(f) || '' === f) {
            a.push(f.replace(/[+]/g, '\\$&'));
            var _ = e.convert(e.emojiList[f].uc_full),
              o = 0;
            for (
              e.shortnameLookup[_] = f.replace(/[+]/g, '\\$&'), o = 0;
              o < e.emojiList[f].shortnames.length;
              o++
            )
              a.push(e.emojiList[f].shortnames[o].replace(/[+]/g, '\\$&')),
                (e.altShortNames[e.emojiList[f].shortnames[o]] = f);
          }
        (e.shortnames = a.join('|')),
          (e.regShortNames = new RegExp(
            '<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(' +
              e.shortnames +
              ')',
            'gi'
          ...
          (e.toImage = function (f) {
            return (f = e.toShort(f)), (f = e.shortnameToImage(f));
          }),
          (e.unicodeToImage = function (e) {
            return e;
          }),
          (e.unifyUnicode = function (f) {
            return (f = e.toShort(f)), (f = e.shortnameToUnicode(f));
          }),
          (e.shortnameToAscii = function (f) {
            var a,
              _ = e.objectFlip(e.asciiList);
            return (f = f.replace(e.regShortNames, function (f) {
              return 'undefined' !== typeof f && '' !== f && f in e.emojiList
                ? ((a = e.emojiList[f].uc_full),
                  'undefined' !== typeof _[a] ? _[a] : f)
                : f;
            }));
          }),
          (e.shortnameToUnicode = function (f) {
            var a;
            if (
              ((f = f.replace(e.regShortNames, function (f) {
                if ('undefined' === typeof f || '' === f) return f;
                if (!(f in e.emojiList)) {
                  if (!(f in e.altShortNames)) return f;
                  f = e.altShortNames[f];
                }
                return (
                  (a = e.emojiList[f].uc_full.toUpperCase()),
                  e.emojiList[f].uc_base,
                  e.convert(a)
                );
              })),
              e.ascii)
            ) {
              var _ = e.riskyMatchAscii ? e.regAsciiRisky : e.regAscii;
              f = f.replace(_, function (f, _, o, s) {
                return 'undefined' !== typeof s &&
                  '' !== s &&
                  e.unescapeHTML(s) in e.asciiList
                  ? ((s = e.unescapeHTML(s)),
                    (a = e.asciiList[s].toUpperCase()),
                    o + e.convert(a))
                  : f;
              });
            }
          ...
          (e.shortnameToImage = function (f) {
            ...
            if (
              ((f = f.replace(e.regShortNames, function (f) {
                ...
                return (
                  (_ = e.emojiList[f].uc_full),
                  (o = e.emojiList[f].uc_base),
                  (t =
                    o.indexOf('-1f3f') >= 0
                      ? 'diversity'
                      : e.emojiList[f].category),
                  (c = e.imageTitleTag ? 'title="' + f + '"' : ''),
                  (n =
                    '32' == e.spriteSize || '64' == e.spriteSize
                      ? e.spriteSize
                      : '32'),
                  (u =
                    e.defaultPathPNG !== e.imagePathPNG
                      ? e.imagePathPNG
                      : e.defaultPathPNG + e.emojiSize + '/'),
                  (s = e.unicodeAlt ? e.convert(_.toUpperCase()) : f),
                  e.sprites
              ...
              var l = e.riskyMatchAscii ? e.regAsciiRisky : e.regAscii;
              f = f.replace(l, function (f, o, l, r) {
                if (
                  'undefined' === typeof r ||
                  '' === r ||
                  !(e.unescapeHTML(r) in e.asciiList)
                )
                  return f;
                (r = e.unescapeHTML(r)), (_ = e.asciiList[r]);
                var m = e.mapUnicodeToShort();
                return (
                  (a = m[_]),
                  (t =
                    _.indexOf('-1f3f') >= 0
                      ? 'diversity'
                      : e.emojiList[a].category),
                  (c = e.imageTitleTag
                    ? 'title="' + e.escapeHTML(r) + '"'
                    : ''),
                  (n =
                    '32' == e.spriteSize || '64' == e.spriteSize
                      ? e.spriteSize
          ...
          (e.toShort = function (f) {
            var a = e.unicodeCharRegex();
            return (f = e.replaceAll(f, a));
          }),
          ...
          (e.shortnameConversionMap = function () {
            var f,
              a = [];
            for (f in e.emojiList)
              e.emojiList.hasOwnProperty(f) &&
                '' !== f &&
                (a[e.convert(e.emojiList[f].uc_full)] = f);
            return a;
          }),
          (e.unicodeCharRegex = function () {
            if (!e.unicodeCharRegexCached) {
              var a = [];
              for (f in e.emojiList)
                e.emojiList.hasOwnProperty(f) &&
                  '' !== f &&
                  a.push(e.convert(e.emojiList[f].uc_full));
              e.unicodeCharRegexCached = a.join('|');
            }
            return e.unicodeCharRegexCached;
          }),
          (e.mapEmojiList = function (f) {
            for (var a in e.emojiList) {
              if (e.emojiList.hasOwnProperty(a)) f(e.emojiList[a].uc_full, a);
            }
          }),
          (e.mapUnicodeToShort = function () {
            return (
              e.memMapShortToUnicode ||
                ((e.memMapShortToUnicode = {}),
                e.mapEmojiList(function (f, a) {
                  e.memMapShortToUnicode[f] = a;
                })),
              e.memMapShortToUnicode
            );
          }),
          (e.memorizeReplacement = function () {
            if (
              !e.unicodeReplacementRegEx ||
              !e.memMapShortToUnicodeCharacters
            ) {
              var f = [];
              (e.memMapShortToUnicodeCharacters = {}),
                e.mapEmojiList(function (a, _) {
                  var o = e.convert(a);
                  (e.memMapShortToUnicodeCharacters[o] = _), f.push(o);
                }),
                (e.unicodeReplacementRegEx = f.join('|'));
            }
          }),
          (e.mapUnicodeCharactersToShort = function () {
            return e.memorizeReplacement(), e.memMapShortToUnicodeCharacters;
          }),
          (e.objectFlip = function (e) {
            var f,
              a = {};
            for (f in e) e.hasOwnProperty(f) && (a[e[f]] = f);
            return a;
          }),
          (e.escapeRegExp = function (e) {
            return e.replace(/[-[\]{}()*+?.,;:&\\^$#\s]/g, '\\$&');
          }),
          (e.replaceAll = function (f, a) {
            var _ = e.escapeRegExp(a),
              o = new RegExp(
                '<object[^>]*>.*?</object>|<span[^>]*>.*?</span>|<(?:object|embed|svg|img|div|span|p|a)[^>]*>|(' +
                  _ +
                  ')',
            ...
            return f.replace(o, function (f, a) {
