  ...
  [5],
  {
                ...
                return (
                  ((e =
                    ...
                    if (
                      ...
                      var n = l.a.findDOMNode(f(e)).getBoundingClientRect();
                      t.updateItem(
                        'setAlignment',
        ...
        var t = Object(r.useState)({}),
          ...
          d = Object(r.useCallback)(function (t) {
            var n = setTimeout(function () {
              ...
              if (t && r) {
                var o = g(s.current.parentElement),
          ...
          Object(r.useEffect)(
            function () {
              return (
                ...
                e.store.subscribeToItem('alignment', h),
                function () {
                  e.store.unsubscribeFromItem('visibleBlock', d),
                    e.store.unsubscribeFromItem('alignment', h);
                }
              );
            },
            [d, h]
          ...
          blockRendererFn: function (e, t) {
            ...
            return {
              props: {
                ...
                setAlignment: p(e, { getEditorState: n, setEditorState: r }),
              },
            };
          },
          AlignmentTool: function () {
            return o.a.createElement(h, { store: t, theme: r });
          },
        };
      };
    },
    OtnB: function (e, t, n) {
      ...
      var u = l({
        ...
        g = i({ blockType: 'header-one', children: 'H1' }),
        h = i({ blockType: 'header-two', children: 'H2' }),
        v = i({ blockType: 'header-three', children: 'H3' }),
        p = i({
