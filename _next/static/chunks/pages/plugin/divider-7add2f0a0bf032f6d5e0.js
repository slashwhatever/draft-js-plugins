  ...
  [20],
  {
    ...
    OtnB: function (e, t, n) {
      ...
      var s = l({
        ...
        p = c({ blockType: 'header-one', children: 'H1' }),
        g = c({ blockType: 'header-two', children: 'H2' }),
        m = c({ blockType: 'header-three', children: 'H3' }),
        h = c({
    ...
    fWkA: function (e, t, n) {
        ...
        x = function (e) {
          ...
          return {
            ...
            DividerButton: function (e) {
              return s.a.createElement(g, L({}, e, { addDivider: B(r) }));
            },
            addDivider: B(r),
          };
        },
      ...
      var P = Object(S.a)(),
        _ = x({ decorator: Object(b.a)(P.decorator) }),
        D = _.DividerButton,
        A = Object(E.a)(),
        F = A.SideToolbar,
        H = [P, _, A],
    ...
    hNl4: function (e, t, n) {
      ...
      p.propTypes = { childNodes: c.a.func };
      var g = (function (e) {
        function t() {
          for (var t, n = arguments.length, r = new Array(n), o = 0; o < n; o++)
            r[o] = arguments[o];
