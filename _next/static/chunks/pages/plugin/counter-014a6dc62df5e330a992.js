          ...
          i = (function (t) {
            var e,
              n = t
                ...
                .replace(/(?:\r\n|\r|\n)/g, '')
                .trim();
            return ((e = n), S.a.ucs2.decode(e)).length;
          })(o.getEditorState()),
          s = (function (t) {
        ...
        P = function (t) {
          ...
          return {
            CharCounter: function (t) {
              return c.a.createElement(j, x({}, t, { theme: n, store: e }));
            },
            WordCounter: function (t) {
              return c.a.createElement(E, x({}, t, { theme: n, store: e }));
            },
            LineCounter: function (t) {
              return c.a.createElement(O, x({}, t, { theme: n, store: e }));
            },
            CustomCounter: function (t) {
              return c.a.createElement(_, x({}, t, { theme: n, store: e }));
            },
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return K(
                    ...
                    K('div', null, K(G, { limit: 200 }), ' characters'),
                    K('div', null, K(Q, { limit: 30 }), ' words'),
                    K('div', null, K(V, { limit: 10 }), ' lines'),
                    K(
                      'div',
                      null,
                      K($, {
                ...
                if (((p = t[i]) < e && ++n > u && g('overflow'), p == e)) {
                  for (
                    ...
                    (x = l - m),
                      ...
                      j.push(f(w(m + (x % C), 0))),
                      (l = h(x / C));
                  j.push(f(w(l, 0))), (a = S(n, b, r == o)), (n = 0), ++r;
                }
              ++n, ++e;
            }
            return j.join('');
